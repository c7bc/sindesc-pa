      ...
      <section className="bg-primary py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="mb-12 md:mb-16">
            <PublicationsHero
              badge="Publicações"
              title="Fique por dentro de tudo que acontece no SINDESC-PA"
              description="Notícias, artigos, revistas e cartilhas sobre a categoria dos profissionais de enfermagem e saúde."
            />
          </div>
