...
const defaultCTAContent: CTAContent = {
  ...
  description: 'Faça parte do maior SINDESC.',
...
const defaultAnnouncementContent: AnnouncementContent = {
  imageUrl: '/cta.jpg',
  imageAlt: 'A voz dos profissionais da enfermagem',
        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-8">
          <div className="lg:w-2/3">
            <PageTitle
              ...
              description="Convenções aplicáveis a toda a categoria dos profissionais da enfermagem do Estado."
            />
