...
const defaultCTAContent: CTAContent = {
  title: "Junte-se à luta pelos direitos dos profissionais de enfermagem e saúde",
  description: "Faça parte do SINDESC-PA. Garantimos representação forte, assistência jurídica completa e defesa dos seus direitos trabalhistas.",
  ...
  return (
    <main className="flex-1">
      <section className="bg-primary py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <PublicationsHero
            ...
            description="Inscreva-se na newsletter do SINDESC-PA e fique por dentro das principais notícias, eventos e conquistas da categoria."
          />
        </div>
      </section>
      ...
      <FormSection
        ...
        checkboxLabel="Aceito receber comunicações do SINDESC-PA por e-mail e outros canais digitais."
