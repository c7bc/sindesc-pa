...
const defaultCTAContent: CTAContent = {
  title: "Junte-se à luta pelos direitos dos profissionais de saúde",
  description: "Faça parte do SINDESC. Garantimos representação forte, assistência jurídica completa e defesa dos seus direitos trabalhistas.",
  ...
  imageAlt: "Profissionais de enfermagem e saúde",
};

const defaultAnnouncementContent: AnnouncementContent = {
  imageUrl: "/cta.jpg",
  imageAlt: "Profissionais de saúde",
  title: "A voz da saúde não para!",
  description: "Receba notícias, atualizações e conquistas da categoria direto no seu e-mail. Fique por dentro das ações do sindicato e fortaleça a luta por melhores condições de trabalho na saúde.",
...
const mockRecentNews: NewsItem[] = [
  {
    ...
    imageAlt: "Profissionais de enfermagem",
    category: "Saúde",
    date: "3 de novembro de 2025",
    title: "Nova convenção coletiva garante aumento salarial de 8% para profissionais de enfermagem",
    link: "#",
  },
  {
    id: "2",
    ...
    title: "SINDESC fecha acordo histórico com hospitais da região de Castanhal",
    link: "#",
  },
  {
    id: "3",
    ...
    title: "Justiça reconhece direito a insalubridade para profissionais de saúde noturnos",
    link: "#",
  },
  {
    id: "4",
    imageUrl: "https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&q=80",
    imageAlt: "Capacitação em saúde",
    category: "Capacitação",
    date: "28 de outubro de 2025",
    title: "SINDESC promove curso gratuito de atualização para profissionais de enfermagem",
    link: "#",
  },
  {
    id: "5",
