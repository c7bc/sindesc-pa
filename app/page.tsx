...
const defaultCTAContent: CTAContent = {
  title: "Junte-se à luta pelos direitos dos profissionais da enfermagem",
  description: "Faça parte do maior SINDESC. Garantimos representação forte, assistência jurídica completa e defesa dos seus direitos trabalhistas.",
...
const defaultAnnouncementContent: AnnouncementContent = {
  imageUrl: "/cta.jpg",
  imageAlt: "Profissional de enfermagem sorrindo",
  title: "A voz dos profissionais da enfermagem não para!",
...
const mockRecentNews: NewsItem[] = [
  {
    ...
    title: "Nova convenção coletiva garante aumento salarial de 8% para profissionais da enfermagem",
    link: "#",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    title: "Justiça reconhece direito a insalubridade para profissionais da enfermagem noturnos",
    link: "#",
  },
  {
    id: "4",
