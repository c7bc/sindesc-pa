...
const defaultItems: ContentItem[] = [
  {
    ...
    description: "Confira as últimas conquistas do SINDESC",
    link: "#",
  },
  {
    id: "2",
    ...
    description: "Saiba mais sobre os direitos dos profissionais de enfermagem e saúde",
    link: "#",
  },
  {
    id: "3",
    ...
    description: "Participe das atividades do SINDESC",
    link: "#",
  },
];
...
export default function ContentShowcase({
  ...
  description = "Acompanhe as últimas novidades e conquistas do SINDESC",
  items = defaultItems,
  buttonText = "Ver mais",
  buttonHref = "#",
