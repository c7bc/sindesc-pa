<div align="center">
  <img src="./public/hero.jpeg" alt="SINDESC-PA" width="100%" />

  # 🏥 SINDESC-PA - Sindicato dos Profissionais de Enfermagem e Saúde de Castanhal

  ### Plataforma digital moderna para representação e defesa dos direitos dos profissionais de enfermagem e saúde
...
O **SINDESC-PA** é uma plataforma web institucional desenvolvida para fortalecer a comunicação entre o sindicato e os profissionais de enfermagem e saúde da região de Castanhal. O sistema oferece acesso a informações sobre direitos trabalhistas, serviços exclusivos, publicações relevantes e facilita o processo de sindicalização.
...
```bash
git clone https://github.com/c7bc/sindesc-pa.git
cd sindesc-pa
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/c7bc/sindesc-pa)
...
Este projeto é privado e pertence ao **SINDESC-PA - Sindicato dos Profissionais de Enfermagem e Saúde de Castanhal**.
...
### Sede
- 📍 Endereço: Rua Paes de Carvalho, 730 - Nova Olinda, Castanhal - PA, 68.742-510
- 📧 Email: Sindescpara@gmail.com
- 📱 Contato: (91) 3712-1043
- ⚖️ Contato Jurídico: (91) 9243-9469
- 🕐 Horário de Atendimento: 8h às 12h e 14h às 18h (segunda a sexta-feira)

### Sobre o SINDESC

Os profissionais de enfermagem e demais empregados que atuam em hospitais e casas de saúde da região — Castanhal, Inhangapí, São Francisco do Pará, Igarapé-Açu, Curuçá, Marapanim e Santa Maria do Pará — contam com o SINDESC como uma estrutura sólida de proteção, orientação e defesa dos seus direitos.

Além disso, o SINDESC atua de forma coletiva e individual, promovendo ações, realizando mediações com instituições de saúde e fortalecendo a voz da categoria frente ao setor público e privado.

Nossa missão é garantir que cada trabalhador da saúde exerça sua função com dignidade, segurança e respeito com respaldo jurídico e representação ativa em todas as esferas necessárias.

---

<div align="center">

  **Desenvolvido com ❤️ para os profissionais de enfermagem e saúde de Castanhal**

  © 2025 SINDESC-PA - Sindicato dos Profissionais de Enfermagem e Saúde de Castanhal. Todos os direitos reservados.
